...
python slformer/main.py --config_file=/home/tinglu/Projects/SLformer_ting/SLformer/config/cancer_specific2.yaml --wandb_track=0 --save_model=0 --save_result=1 --add_att=1 --att_nhead=2 --batch_size=512 --transformer_hidden_dim=256 --dropout=0.1 --eps=1e-05 --weight_decay=1e-05 --transformer_lr=1e-5 --predictor_lr=1e-4 --mlp_hidden_dim=128 --n_head=1 --num_layers=1 --n=10 --device=0
